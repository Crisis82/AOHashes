...
/// Rescue-Prime parameters generation.
mod params;
...
/// Rescue-Prime permutation struct operating in a plonk-circuit.
#[cfg(feature = "zk")]
pub(crate) mod gadget;

/// Rescue-Prime permutation struct operating on [`BlsScalar`].
pub(crate) mod scalar;

/// Defines the Rescue-Prime permutation algorithm.
pub(crate) trait RescueXLIX<T> {
